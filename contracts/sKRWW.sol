...
contract sKRWW is ERC4626, ERC20Pausable, AccessControl, ERC20Permit {
    ...
    constructor(
        ...
        ERC4626(_asset)
        ERC20("Staked Korean Won Wonder", "sKRWW")
        ERC20Permit("Staked Korean Won Wonder")
    {
    ...
    function name() public pure override(ERC20, IERC20Metadata) returns (string memory) {
        return "Staked Korean Won Wonder";
    }
